...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class WindowT2FormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        ...
        public override LocString DisplayName => Localizer.DoStr("Window T2");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Window T2");
