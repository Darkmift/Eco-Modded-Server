...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class RoofEdgeSideFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "RoofEdgeSide";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Roof Side Curved Edge Block");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Roof Side Curved Edge Block");
        ...
        public override int SortOrder => 195;
