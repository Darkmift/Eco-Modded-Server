...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class RoofUnderslopeTurnFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "RoofUnderslopeTurn";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Roof Underslope Turn");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Roof Underslope Turn");
        ...
        public override int SortOrder => 207;
