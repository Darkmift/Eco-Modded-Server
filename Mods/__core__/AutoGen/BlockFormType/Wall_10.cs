...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class Wall_10FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "Wall_10";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall Framed Vertical Pattern");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall Framed Vertical Pattern");
        ...
        public override int SortOrder => 166;
