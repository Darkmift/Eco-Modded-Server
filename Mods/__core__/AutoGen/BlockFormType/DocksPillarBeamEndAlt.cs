...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class DocksPillarBeamEndAltFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "DocksPillarBeamEndAlt";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Docks Pillar Beam End Cap Alternate");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Docks Pillar Beam End Cap Alternate");
