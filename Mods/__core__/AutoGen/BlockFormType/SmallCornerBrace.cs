...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class SmallCornerBraceFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "SmallCornerBrace";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Small Corner Brace");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Small Corner Brace");
