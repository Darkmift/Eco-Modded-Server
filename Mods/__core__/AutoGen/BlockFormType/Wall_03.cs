...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class Wall_03FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "Wall_03";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall Framed Top And Bottom");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall Framed Top And Bottom");
        ...
        public override int SortOrder => 159;
