...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class ThinWallStraightFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "ThinWallStraight";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Thin Wall Straight");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Thin Wall Straight");
