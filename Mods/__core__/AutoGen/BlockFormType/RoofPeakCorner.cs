...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class RoofPeakCornerFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "RoofPeakCorner";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Roof Peak Corner");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Roof Peak Corner");
