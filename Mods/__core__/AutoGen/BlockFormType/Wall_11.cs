...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class Wall_11FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "Wall_11";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall Decorative Block");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall Decorative Block");
        ...
        public override int SortOrder => 167;
