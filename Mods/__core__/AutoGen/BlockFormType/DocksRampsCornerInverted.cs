...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class DocksRampsCornerInvertedFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "DocksRampsCornerInverted";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Docks Ramps Corner Inverted");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Docks Ramps Corner Inverted");
        ...
        public override int SortOrder => 126;
