...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class BasicSlopeTurnFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "BasicSlopeTurn";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Basic Slope Turn");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Basic Slope Turn");
        ...
        public override int SortOrder => 39;
