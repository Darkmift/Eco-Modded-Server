...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class WallT_03FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "WallT_03";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall T Framed Top And Bottom");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall T Framed Top And Bottom");
        ...
        public override int SortOrder => 174;
