...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class Wall_05FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "Wall_05";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall Framed Vertical Edge");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall Framed Vertical Edge");
