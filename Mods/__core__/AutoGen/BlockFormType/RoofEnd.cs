...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class RoofEndFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "RoofEnd";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Roof End Piece");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Roof End Piece");
        ...
        public override int SortOrder => 141;
