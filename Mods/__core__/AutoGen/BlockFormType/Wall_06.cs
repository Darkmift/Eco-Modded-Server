...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class Wall_06FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "Wall_06";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall Framed Vertical Edge Double");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall Framed Vertical Edge Double");
        ...
        public override int SortOrder => 162;
