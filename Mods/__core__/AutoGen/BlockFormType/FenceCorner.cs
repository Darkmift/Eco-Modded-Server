...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class FenceCornerFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "FenceCorner";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Fence Corner Block");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Fence Corner Block");
        ...
        public override int SortOrder => 146;
