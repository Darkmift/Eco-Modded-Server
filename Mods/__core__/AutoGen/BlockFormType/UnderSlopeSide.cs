...
namespace Eco.Mods.TechTree
{
    ...
    public partial class UnderSlopeSideFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "UnderSlopeSide";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Under Slope Side");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Under Slope Side");
        ...
        public override int SortOrder => 53;
