...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class WallT_04FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "WallT_04";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall T Plain With Panel");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall T Plain With Panel");
        ...
        public override int SortOrder => 175;
