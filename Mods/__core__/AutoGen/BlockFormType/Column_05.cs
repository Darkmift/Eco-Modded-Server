...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class Column_05FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "Column_05";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Column C Block");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Column C Block");
        ...
        public override int SortOrder => 184;
