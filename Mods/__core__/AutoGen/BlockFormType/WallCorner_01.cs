...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class WallCorner_01FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "WallCorner_01";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall Corner Plain");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall Corner Plain");
        ...
        public override int SortOrder => 168;
