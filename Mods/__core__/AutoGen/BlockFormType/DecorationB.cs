...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class DecorationBFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "DecorationB";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Decoration B");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Decoration B");
        ...
        public override int SortOrder => 154;
