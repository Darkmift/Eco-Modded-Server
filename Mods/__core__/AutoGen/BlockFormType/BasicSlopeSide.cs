...
namespace Eco.Mods.TechTree
{
    ...
    public partial class BasicSlopeSideFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "BasicSlopeSide";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Basic Slope Side");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Basic Slope Side");
        ...
        public override int SortOrder => 37;
