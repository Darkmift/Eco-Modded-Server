...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class FenceSoloFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "FenceSolo";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Fence Solo Block");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Fence Solo Block");
        ...
        public override int SortOrder => 143;
