...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class ThinFloorBottomFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "ThinFloorBottom";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Thin Floor Bottom");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Thin Floor Bottom");
        ...
        public override int SortOrder => 89;
