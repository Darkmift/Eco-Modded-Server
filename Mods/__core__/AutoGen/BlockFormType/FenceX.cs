...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class FenceXFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "FenceX";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Fence X Intersection");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Fence X Intersection");
        ...
        public override int SortOrder => 147;
