...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class Wall_14FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "Wall_14";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall Framed Corner Bottom");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall Framed Corner Bottom");
        ...
        public override int SortOrder => 187;
