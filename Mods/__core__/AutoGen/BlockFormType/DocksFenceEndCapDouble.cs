...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class DocksFenceEndCapDoubleFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "DocksFenceEndCapDouble";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Docks Fence End Double");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Docks Fence End Double");
        ...
        public override int SortOrder => 127;
