...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class RoofSoloFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "RoofSolo";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Roof Single Block");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Roof Single Block");
        ...
        public override int SortOrder => 137;
