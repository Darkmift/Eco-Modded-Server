...
namespace Eco.Mods.TechTree
{
    ...
    public partial class StairsMidFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "StairsMid";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Stairs Mid Block");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Stairs Mid Block");
        ...
        public override int SortOrder => 149;
