...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class Column_02FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "Column_02";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Column Mid Block");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Column Mid Block");
        ...
        public override int SortOrder => 181;
