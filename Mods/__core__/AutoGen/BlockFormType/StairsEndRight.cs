...
namespace Eco.Mods.TechTree
{
    ...
    public partial class StairsEndRightFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "StairsEndRight";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Stairs End Right");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Stairs End Right");
        ...
        public override int SortOrder => 151;
