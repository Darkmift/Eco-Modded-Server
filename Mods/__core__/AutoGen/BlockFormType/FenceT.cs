...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class FenceTFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "FenceT";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Fence T Intersection");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Fence T Intersection");
        ...
        public override int SortOrder => 148;
