...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class DocksPillarBeamTFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "DocksPillarBeamT";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Docks Pillar Beam T Intersection");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Docks Pillar Beam T Intersection");
        ...
        public override int SortOrder => 129;
