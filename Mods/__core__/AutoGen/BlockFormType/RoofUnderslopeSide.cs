...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class RoofUnderslopeSideFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "RoofUnderslopeSide";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Roof Underslope Side");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Roof Underslope Side");
        ...
        public override int SortOrder => 208;
