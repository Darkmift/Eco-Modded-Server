...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class FenceEndFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "FenceEnd";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Fence End Block");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Fence End Block");
        ...
        public override int SortOrder => 145;
