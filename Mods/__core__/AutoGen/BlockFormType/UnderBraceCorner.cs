...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class UnderBraceCornerFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "UnderBraceCorner";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Under Brace Corner");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Under Brace Corner");
