...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class WallT_02FormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "WallT_02";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Wall T Framed Top With Panel");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Wall T Framed Top With Panel");
        ...
        public override int SortOrder => 173;
