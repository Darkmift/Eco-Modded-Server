...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class RoofUnderslopeCornerFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "RoofUnderslopeCorner";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Roof Underslope Corner");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Roof Underslope Corner");
        ...
        public override int SortOrder => 206;
