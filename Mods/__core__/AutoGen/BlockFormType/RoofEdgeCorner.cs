...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class RoofEdgeCornerFormType : FormType, IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "RoofEdgeCorner";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Roof Corner Edge");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Roof Corner Edge");
        ...
        public override int SortOrder => 205;
