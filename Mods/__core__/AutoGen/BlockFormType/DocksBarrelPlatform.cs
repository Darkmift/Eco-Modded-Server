...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    public partial class DocksBarrelPlatformFormType : FormType, IWaterLoggedBlock , IColoredBlock     {
        /// <summary>Basic name of the block form type.</summary>
        public override string Name => "DocksBarrelPlatform";
        /// <summary>The plural localization name for the block form type.</summary>
        public override LocString DisplayName => Localizer.DoStr("Docks Barrel Platform");
        /// <summary>The tooltip description for the block form type.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Docks Barrel Platform");
