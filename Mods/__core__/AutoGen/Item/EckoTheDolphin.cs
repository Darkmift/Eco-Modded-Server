...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Ecko The Dolphin")] // Defines the localized name of the item.
    [Weight(0)] // Defines how heavy EckoTheDolphin is.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [LocDescription("Ecko, the dolphin god of Eco bugs. Handle with care and lightly sprinkle with water every so often to keep moist.")] //The tooltip description for the item.
