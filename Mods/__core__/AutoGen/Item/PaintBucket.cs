...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Paint Bucket")] // Defines the localized name of the item.
    [Ecopedia("Items", "Products", createAsSubPage: true)]
    [LocDescription("Mixed and ready to go, just need to apply and let dry.")] //The tooltip description for the item.
    public partial class PaintBucketItem : ColorItem    {
