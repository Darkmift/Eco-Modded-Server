...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Fir Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the FirSeed is.
    ...
    [LocDescription("Plant to grow a fir tree.")] //The tooltip description for the food item.
    public partial class FirSeedItem : SeedItem
    {
        static FirSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Fir");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Fir Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the FirSeed is.
    [LocDescription("Plant to grow a fir tree.")] //The tooltip description for the seed pack item.
