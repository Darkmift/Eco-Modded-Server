...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Heliconia Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the HeliconiaSeed is.
    ...
    [LocDescription("Plant to grow heliconia.")] //The tooltip description for the food item.
    public partial class HeliconiaSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Heliconia");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Heliconia Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the HeliconiaSeed is.
    [LocDescription("Plant to grow heliconia.")] //The tooltip description for the seed pack item.
