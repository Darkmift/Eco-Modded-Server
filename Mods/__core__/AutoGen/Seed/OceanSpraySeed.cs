...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Ocean Spray Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the OceanSpraySeed is.
    ...
    [LocDescription("Plant to grow ocean spray.")] //The tooltip description for the food item.
    public partial class OceanSpraySeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("OceanSpray");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Ocean Spray Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the OceanSpraySeed is.
    [LocDescription("Plant to grow ocean spray.")] //The tooltip description for the seed pack item.
