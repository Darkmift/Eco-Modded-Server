...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Lupine Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the LupineSeed is.
    ...
    [LocDescription("Plant to grow lupine.")] //The tooltip description for the food item.
    public partial class LupineSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Lupine");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Lupine Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the LupineSeed is.
    [LocDescription("Plant to grow lupine.")] //The tooltip description for the seed pack item.
