...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Jointfir Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the JointfirSeed is.
    ...
    [LocDescription("Plant to grow a jointfir.")] //The tooltip description for the food item.
    public partial class JointfirSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Jointfir");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Jointfir Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the JointfirSeed is.
    [LocDescription("Plant to grow a jointfir.")] //The tooltip description for the seed pack item.
