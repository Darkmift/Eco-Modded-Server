...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Spruce Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the SpruceSeed is.
    ...
    [LocDescription("Plant to grow a spruce tree.")] //The tooltip description for the food item.
    public partial class SpruceSeedItem : SeedItem
    {
        static SpruceSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Spruce");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Spruce Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the SpruceSeed is.
    [LocDescription("Plant to grow a spruce tree.")] //The tooltip description for the seed pack item.
    public partial class SpruceSeedPackItem : SeedPackItem
    {
        static SpruceSeedPackItem() { }

        /// <summary>The name of the plant species this seed pack is responsible for</summary>
        public override LocString SpeciesName        { get { return Localizer.DoStr("Spruce"); } }
    }
