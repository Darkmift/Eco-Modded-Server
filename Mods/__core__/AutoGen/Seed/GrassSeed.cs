...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Grass Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the GrassSeed is.
    ...
    [LocDescription("Plant to grow grass.")] //The tooltip description for the food item.
    public partial class GrassSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("CommonGrass");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Grass Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the GrassSeed is.
    [LocDescription("Plant to grow grass.")] //The tooltip description for the seed pack item.
