...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Redwood Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the RedwoodSeed is.
    ...
    [LocDescription("Plant to grow a redwood tree.")] //The tooltip description for the food item.
    public partial class RedwoodSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Redwood");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Redwood Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the RedwoodSeed is.
    [LocDescription("Plant to grow a redwood tree.")] //The tooltip description for the seed pack item.
