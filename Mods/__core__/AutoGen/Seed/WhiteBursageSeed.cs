...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("White Bursage Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the WhiteBursageSeed is.
    ...
    [LocDescription("Plant to grow a white bursage.")] //The tooltip description for the food item.
    public partial class WhiteBursageSeedItem : SeedItem
    {
        static WhiteBursageSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("WhiteBursage");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("White Bursage Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the WhiteBursageSeed is.
    [LocDescription("Plant to grow a white bursage.")] //The tooltip description for the seed pack item.
    public partial class WhiteBursageSeedPackItem : SeedPackItem
    {
        static WhiteBursageSeedPackItem() { }

        /// <summary>The name of the plant species this seed pack is responsible for</summary>
        public override LocString SpeciesName        { get { return Localizer.DoStr("WhiteBursage"); } }
    }
