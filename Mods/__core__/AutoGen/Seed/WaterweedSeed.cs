...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Waterweed Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the WaterweedSeed is.
    ...
    [LocDescription("Plant to grow waterweed.")] //The tooltip description for the food item.
    public partial class WaterweedSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Waterweed");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Waterweed Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the WaterweedSeed is.
    [LocDescription("Plant to grow waterweed.")] //The tooltip description for the seed pack item.
