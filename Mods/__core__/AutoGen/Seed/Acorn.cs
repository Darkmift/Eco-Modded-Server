...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Acorn")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the Acorn is.
    ...
    [LocDescription("Plant to grow an oak tree.")] //The tooltip description for the food item.
    public partial class AcornItem : SeedItem
    {
        static AcornItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Oak");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Acorn Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the Acorn is.
    [LocDescription("Plant to grow an oak tree.")] //The tooltip description for the seed pack item.
