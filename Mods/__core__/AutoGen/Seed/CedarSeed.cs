...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Cedar Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the CedarSeed is.
    ...
    [LocDescription("Plant to grow a cedar sapling.")] //The tooltip description for the food item.
    public partial class CedarSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Cedar");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Cedar Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the CedarSeed is.
    [LocDescription("Plant to grow a cedar sapling.")] //The tooltip description for the seed pack item.
