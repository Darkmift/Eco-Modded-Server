...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Bullrush Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the BullrushSeed is.
    ...
    [LocDescription("Plant to grow bullrush.")] //The tooltip description for the food item.
    public partial class BullrushSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Bullrush");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Bullrush Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the BullrushSeed is.
    [LocDescription("Plant to grow bullrush.")] //The tooltip description for the seed pack item.
