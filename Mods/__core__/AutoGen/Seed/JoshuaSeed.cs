...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Joshua Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the JoshuaSeed is.
    ...
    [LocDescription("Plant to grow a joshua tree.")] //The tooltip description for the food item.
    public partial class JoshuaSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Joshua");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Joshua Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the JoshuaSeed is.
    [LocDescription("Plant to grow a joshua tree.")] //The tooltip description for the seed pack item.
