...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Arctic Willow Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the ArcticWillowSeed is.
    ...
    [LocDescription("Plant to grow arctic willow.")] //The tooltip description for the food item.
    public partial class ArcticWillowSeedItem : SeedItem
    {
        static ArcticWillowSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("ArcticWillow");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Arctic Willow Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the ArcticWillowSeed is.
    [LocDescription("Plant to grow arctic willow.")] //The tooltip description for the seed pack item.
    public partial class ArcticWillowSeedPackItem : SeedPackItem
    {
        static ArcticWillowSeedPackItem() { }

        /// <summary>The name of the plant species this seed pack is responsible for</summary>
        public override LocString SpeciesName        { get { return Localizer.DoStr("ArcticWillow"); } }
    }
