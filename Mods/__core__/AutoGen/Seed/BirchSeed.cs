...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Birch Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the BirchSeed is.
    ...
    [LocDescription("Plant to grow into a birch sapling.")] //The tooltip description for the food item.
    public partial class BirchSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Birch");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Birch Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the BirchSeed is.
    [LocDescription("Plant to grow into a birch sapling.")] //The tooltip description for the seed pack item.
