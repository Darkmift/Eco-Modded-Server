...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Barrel Cactus Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the BarrelCactusSeed is.
    ...
    [LocDescription("Plant to grow barrel cactus.")] //The tooltip description for the food item.
    public partial class BarrelCactusSeedItem : SeedItem
    {
        static BarrelCactusSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("BarrelCactus");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Barrel Cactus Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the BarrelCactusSeed is.
    [LocDescription("Plant to grow barrel cactus.")] //The tooltip description for the seed pack item.
    public partial class BarrelCactusSeedPackItem : SeedPackItem
    {
        static BarrelCactusSeedPackItem() { }

        /// <summary>The name of the plant species this seed pack is responsible for</summary>
        public override LocString SpeciesName        { get { return Localizer.DoStr("BarrelCactus"); } }
    }
