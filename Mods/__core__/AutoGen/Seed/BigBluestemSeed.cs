...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Big Bluestem Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the BigBluestemSeed is.
    ...
    [LocDescription("Plant to grow a big bluestem plant.")] //The tooltip description for the food item.
    public partial class BigBluestemSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("BigBluestem");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Big Bluestem Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the BigBluestemSeed is.
    [LocDescription("Plant to grow a big bluestem plant.")] //The tooltip description for the seed pack item.
