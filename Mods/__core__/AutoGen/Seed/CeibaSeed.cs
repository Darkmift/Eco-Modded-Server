...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Ceiba Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the CeibaSeed is.
    ...
    [LocDescription("Plant to grow a ceiba sapling.")] //The tooltip description for the food item.
    public partial class CeibaSeedItem : SeedItem
    {
        static CeibaSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Ceiba");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Ceiba Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the CeibaSeed is.
    [LocDescription("Plant to grow a ceiba sapling.")] //The tooltip description for the seed pack item.
    public partial class CeibaSeedPackItem : SeedPackItem
    {
        static CeibaSeedPackItem() { }

        /// <summary>The name of the plant species this seed pack is responsible for</summary>
        public override LocString SpeciesName        { get { return Localizer.DoStr("Ceiba"); } }
    }
