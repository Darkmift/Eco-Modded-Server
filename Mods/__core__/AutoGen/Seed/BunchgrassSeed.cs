...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Bunchgrass Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the BunchgrassSeed is.
    ...
    [LocDescription("Plant to grow bunchgrass.")] //The tooltip description for the food item.
    public partial class BunchgrassSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("Bunchgrass");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Bunchgrass Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the BunchgrassSeed is.
    [LocDescription("Plant to grow bunchgrass.")] //The tooltip description for the seed pack item.
