...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Lattice Mushroom Spores")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the LatticeMushroomSpores is.
    ...
    [LocDescription("Plant to grow lattice mushrooms.")] //The tooltip description for the food item.
    public partial class LatticeMushroomSporesItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("LatticeMushroom");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Lattice Mushroom Spores Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the LatticeMushroomSpores is.
    [LocDescription("Plant to grow lattice mushrooms.")] //The tooltip description for the seed pack item.
