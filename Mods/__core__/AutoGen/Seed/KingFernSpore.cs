...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("King Fern Spore")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the KingFernSpore is.
    ...
    [LocDescription("Plant to grow king fern.")] //The tooltip description for the food item.
    public partial class KingFernSporeItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("KingFern");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("King Fern Spore Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the KingFernSpore is.
    [LocDescription("Plant to grow king fern.")] //The tooltip description for the seed pack item.
