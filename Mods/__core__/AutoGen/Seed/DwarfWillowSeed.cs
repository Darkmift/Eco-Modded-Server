...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Dwarf Willow Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the DwarfWillowSeed is.
    ...
    [LocDescription("Plant to grow dwarf willow.")] //The tooltip description for the food item.
    public partial class DwarfWillowSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("DwarfWillow");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Dwarf Willow Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the DwarfWillowSeed is.
    [LocDescription("Plant to grow dwarf willow.")] //The tooltip description for the seed pack item.
