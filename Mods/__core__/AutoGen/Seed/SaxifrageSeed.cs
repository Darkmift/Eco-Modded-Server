...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Saxifrage Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the SaxifrageSeed is.
    ...
    [LocDescription("Plant to grow saxifrage.")] //The tooltip description for the food item.
    public partial class SaxifrageSeedItem : SeedItem
    {
        static SaxifrageSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Saxifrage");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Saxifrage Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the SaxifrageSeed is.
    [LocDescription("Plant to grow saxifrage.")] //The tooltip description for the seed pack item.
    public partial class SaxifrageSeedPackItem : SeedPackItem
    {
        static SaxifrageSeedPackItem() { }

        /// <summary>The name of the plant species this seed pack is responsible for</summary>
        public override LocString SpeciesName        { get { return Localizer.DoStr("Saxifrage"); } }
    }
