...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Saguaro Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the SaguaroSeed is.
    ...
    [LocDescription("Plant to grow a saguaro cactus.")] //The tooltip description for the food item.
    public partial class SaguaroSeedItem : SeedItem
    {
        ...
        public override LocString SpeciesName           => Localizer.DoStr("SaguaroCactus");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Saguaro Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the SaguaroSeed is.
    [LocDescription("Plant to grow a saguaro cactus.")] //The tooltip description for the seed pack item.
