...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Palm Seed")] // Defines the localized name of the item.
    [Weight(50)] // Defines how heavy the PalmSeed is.
    ...
    [LocDescription("Plant to grow a palm tree.")] //The tooltip description for the food item.
    public partial class PalmSeedItem : SeedItem
    {
        static PalmSeedItem() { }

        /// <summary>The name of the plant species this seed is responsible for.</summary>
        public override LocString SpeciesName           => Localizer.DoStr("Palm");
    ...
    /// </summary>
    [Serialized] // Tells the save/load system this object needs to be serialized. 
    [LocDisplayName("Palm Seed Pack")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(50)] // Defines how heavy the PalmSeed is.
    [LocDescription("Plant to grow a palm tree.")] //The tooltip description for the seed pack item.
