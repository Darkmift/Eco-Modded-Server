...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsWaterweed : PlantLayerSettings
    {
        ...
        {
            this.Name = "Waterweed";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Waterweed")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Waterweed"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Waterweed".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Waterweed : PlantEntity
    {
        ...
        public partial class WaterweedSpecies : PlantSpecies
        {
            public WaterweedSpecies() : base()
            {
                ...
                this.Name = "Waterweed"; //noloc
                this.DisplayName = Localizer.DoStr("Waterweed"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(12, 28);
                this.GenerationDefinitions.CountOfClusters = new Range(1, 1);
                this.GenerationDefinitions.RadiusOfGroup = new Range(4, 15);
                ...
                // Visuals
                this.BlockType = typeof(WaterweedBlock); // Defines the block type represented by this plant
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.01f, MaxResourceContent = 0.01f }); //noloc
