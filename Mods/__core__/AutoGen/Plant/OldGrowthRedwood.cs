...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsOldGrowthRedwood : PlantLayerSettings
    {
        ...
        {
            this.Name = "OldGrowthRedwood";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Old Growth Redwood")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Old Growth Redwood"; //noloc
            this.VoxelsPerEntry = 20;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "OldGrowthRedwood".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class OldGrowthRedwood : TreeEntity
    {
        ...
        public partial class OldGrowthRedwoodSpecies : TreeSpecies
        {
            public OldGrowthRedwoodSpecies() : base()
            {
                ...
                this.NoSpread = true; // Controls the spread flag. For plants that shouldn't ever grow more. Old growth, mostly. Normal growth is needed for world gen to work properly.
                this.Name = "OldGrowthRedwood"; //noloc
                this.DisplayName = Localizer.DoStr("Old Growth Redwood"); // Define our localized plant display name
                this.DisplayDescription = Localizer.DoStr("Old growth redwood trees develop over centuries, with some living trees being over 2000 years old. Unlike most trees, these are a non-renewable resource and will not grow back if harvested."); // The tooltip description for the item.

                // Lifetime
                this.MaturityAgeDays = 30; // Maturity age in days.  Organisms older than this value are considered fully grown and can reproduce.
                ...
                // Food
                this.CalorieValue = 50; // Defines the calorie value of the plant
                ...
                this.SpreadRate = 0; // The exponential rate parameter describing the rate at which the plant spreads to adjacent locations.
