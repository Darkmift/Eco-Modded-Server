...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsLupine : PlantLayerSettings
    {
        ...
        {
            this.Name = "Lupine";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Lupine")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Lupine"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Lupine".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Lupine : PlantEntity
    {
        ...
        public partial class LupineSpecies : PlantSpecies
        {
            public LupineSpecies() : base()
            {
                ...
                this.Name = "Lupine"; //noloc
                this.DisplayName = Localizer.DoStr("Lupine"); // Define our localized plant display name
                ...
                // Visuals
                this.BlockType = typeof(LupineBlock); // Defines the block type represented by this plant
