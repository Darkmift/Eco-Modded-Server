...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsWhiteBursage : PlantLayerSettings
    {
        ...
        {
            this.Name = "WhiteBursage";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("White Bursage")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "White Bursage"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "WhiteBursage".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class WhiteBursage : PlantEntity
    {
        ...
        public partial class WhiteBursageSpecies : PlantSpecies
        {
            public WhiteBursageSpecies() : base()
            {
                ...
                this.Name = "WhiteBursage"; //noloc
                this.DisplayName = Localizer.DoStr("White Bursage"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(25, 80);
                ...
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(0.12f, 0.18f);
                ...
                // Visuals
                this.BlockType = typeof(WhiteBursageBlock); // Defines the block type represented by this plant
                ...
                // fertilizers.
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Nitrogen", HalfSpeedConcentration = 0.4f, MaxResourceContent = 0.5f }); //noloc
