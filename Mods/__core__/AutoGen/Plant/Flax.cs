...
namespace Eco.Mods.WorldLayers
{
    ...
    /// </remarks>
    public partial class PlantLayerSettingsFlax : PlantLayerSettings
    {
        public PlantLayerSettingsFlax() : base()
        {
            this.Name = "Flax";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Flax")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Flax"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Flax".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    {
        public Flax(WorldPosition3i mapPos, PlantPack plantPack) : base(species, mapPos, plantPack) { }
        public Flax() { }
        ...
        {
            public FlaxSpecies() : base()
            {
                species = this;
                this.InstanceType = typeof(Flax);
                this.SetDefaultProperties();

                // Info
                this.Decorative = false; // Controls the decorative flag state. Decorative plants are not simulated after being spawned
                this.Name = "Flax"; //noloc
                this.DisplayName = Localizer.DoStr("Flax"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.RadiusOfGroup = new Range(5, 12);
                ...
                {
                    new SpeciesResource(typeof(FlaxStemItem), new Range(1, 4), 1),
                    new SpeciesResource(typeof(FlaxSeedItem), new Range(1, 2), 0.1f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(FlaxBlock); // Defines the block type represented by this plant
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.08f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Potassium", HalfSpeedConcentration = 0.2f, MaxResourceContent = 0.12f }); //noloc
                ...
                this.IdealTemperatureRange = new Range(0.58f, 0.79f);
    ...
    [MoveEfficiency(0.8f)]
    public partial class FlaxBlock :
        PlantBlock { }
}
