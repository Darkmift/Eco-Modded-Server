...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsKingFern : PlantLayerSettings
    {
        ...
        {
            this.Name = "KingFern";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("King Fern")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "King Fern"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "KingFern".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class KingFern : PlantEntity
    {
        ...
        public partial class KingFernSpecies : PlantSpecies
        {
            public KingFernSpecies() : base()
            {
                ...
                this.Name = "KingFern"; //noloc
                this.DisplayName = Localizer.DoStr("King Fern"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.RadiusOfGroup = new Range(8, 18);
                ...
                // Visuals
                this.BlockType = typeof(KingFernBlock); // Defines the block type represented by this plant
