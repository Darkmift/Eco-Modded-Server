...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsBirch : PlantLayerSettings
    {
        ...
        {
            this.Name = "Birch";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Birch")} Population"); // Sets the localized display name of the plant population layer
    ...
    public partial class Birch : TreeEntity
    {
        ...
        public partial class BirchSpecies : TreeSpecies
        {
            public BirchSpecies() : base()
            {
                ...
                this.Name = "Birch"; //noloc
                this.DisplayName = Localizer.DoStr("Birch"); // Define our localized plant display name

                // Lifetime
                this.MaturityAgeDays = 5; // Maturity age in days.  Organisms older than this value are considered fully grown and can reproduce.
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(30, 60);
                this.GenerationDefinitions.PlantsInGroup = new Range(30, 60);
                this.GenerationDefinitions.CountOfClusters = new Range(3, 6);
                this.GenerationDefinitions.RadiusOfGroup = new Range(10, 24);
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "FertileGround", ConsumedCapacityPerPop = 10 }); //noloc
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "CanopySpace", ConsumedCapacityPerPop = 30 }); //noloc
