...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsSwitchgrass : PlantLayerSettings
    {
        ...
        {
            this.Name = "Switchgrass";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Switchgrass")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Switchgrass"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Switchgrass".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Switchgrass : PlantEntity
    {
        ...
        public partial class SwitchgrassSpecies : PlantSpecies
        {
            public SwitchgrassSpecies() : base()
            {
                ...
                this.Name = "Switchgrass"; //noloc
                this.DisplayName = Localizer.DoStr("Switchgrass"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(18, 28);
                this.GenerationDefinitions.CountOfClusters = new Range(3, 5);
                this.GenerationDefinitions.RadiusOfGroup = new Range(8, 14);
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(0.12f, 0.22f);
                ...
                this.RequireHarvestable = false; // Prevent removal if no resources would be gained.
                ...
                // Visuals
                this.BlockType = typeof(SwitchgrassBlock); // Defines the block type represented by this plant
                ...
                // fertilizers.
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Nitrogen", HalfSpeedConcentration = 0.01f, MaxResourceContent = 0.01f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.01f, MaxResourceContent = 0.01f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Potassium", HalfSpeedConcentration = 0.01f, MaxResourceContent = 0.01f }); //noloc
