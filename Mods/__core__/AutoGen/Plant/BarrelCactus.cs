...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsBarrelCactus : PlantLayerSettings
    {
        ...
        {
            this.Name = "BarrelCactus";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Barrel Cactus")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Barrel Cactus"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "BarrelCactus".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class BarrelCactus : PlantEntity
    {
        ...
        public partial class BarrelCactusSpecies : PlantSpecies
        {
            public BarrelCactusSpecies() : base()
            {
                ...
                this.Name = "BarrelCactus"; //noloc
                this.DisplayName = Localizer.DoStr("Barrel Cactus"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(35, 80);
                this.GenerationDefinitions.PlantsInGroup = new Range(12, 20);
                this.GenerationDefinitions.CountOfClusters = new Range(3, 7);
                this.GenerationDefinitions.RadiusOfGroup = new Range(4, 5);
                ...
                // Visuals
                this.BlockType = typeof(BarrelCactusBlock); // Defines the block type represented by this plant
