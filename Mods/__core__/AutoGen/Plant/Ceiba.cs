...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsCeiba : PlantLayerSettings
    {
        ...
        {
            this.Name = "Ceiba";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Ceiba")} Population"); // Sets the localized display name of the plant population layer
    ...
    public partial class Ceiba : TreeEntity
    {
        ...
        public partial class CeibaSpecies : TreeSpecies
        {
            public CeibaSpecies() : base()
            {
                ...
                this.Name = "Ceiba"; //noloc
                this.DisplayName = Localizer.DoStr("Ceiba"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(5, 12);
                this.GenerationDefinitions.PlantsInGroup = new Range(4, 16);
                this.GenerationDefinitions.CountOfClusters = new Range(1, 1);
                this.GenerationDefinitions.RadiusOfGroup = new Range(8, 16);
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(1, 1);
                this.GenerationDefinitions.StartBiomes = "RainforestBiome";

                // Food
                this.CalorieValue = 30; // Defines the calorie value of the plant
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "CanopySpace", ConsumedCapacityPerPop = 10 }); //noloc
