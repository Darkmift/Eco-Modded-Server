...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsWheat : PlantLayerSettings
    {
        ...
        {
            this.Name = "Wheat";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Wheat")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Wheat"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Wheat".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Wheat : PlantEntity
    {
        ...
        public partial class WheatSpecies : PlantSpecies
        {
            public WheatSpecies() : base()
            {
                ...
                this.Name = "Wheat"; //noloc
                this.DisplayName = Localizer.DoStr("Wheat"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(8, 14);
                this.GenerationDefinitions.CountOfClusters = new Range(2, 5);
                this.GenerationDefinitions.RadiusOfGroup = new Range(4, 12);
                this.GenerationDefinitions.ClusterRadiusInWorldSize = new Range(0.11f, 0.18f);
                ...
                // Visuals
                this.BlockType = typeof(WheatBlock); // Defines the block type represented by this plant
                ...
                // fertilizers.
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Nitrogen", HalfSpeedConcentration = 0.3f, MaxResourceContent = 0.3f }); //noloc
