...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsCreosoteBush : PlantLayerSettings
    {
        ...
        {
            this.Name = "CreosoteBush";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Creosote Bush")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Creosote Bush"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "CreosoteBush".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class CreosoteBush : PlantEntity
    {
        ...
        public partial class CreosoteBushSpecies : PlantSpecies
        {
            public CreosoteBushSpecies() : base()
            {
                ...
                this.Name = "CreosoteBush"; //noloc
                this.DisplayName = Localizer.DoStr("Creosote Bush"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(25, 50);
                ...
                {
                    new SpeciesResource(typeof(CreosoteFlowerItem), new Range(1, 3), 1),
                    new SpeciesResource(typeof(CreosoteBushSeedItem), new Range(1, 2), 0.1f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(CreosoteBushBlock); // Defines the block type represented by this plant
