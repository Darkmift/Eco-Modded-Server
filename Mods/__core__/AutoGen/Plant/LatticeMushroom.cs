...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsLatticeMushroom : PlantLayerSettings
    {
        ...
        {
            this.Name = "LatticeMushroom";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Lattice Mushroom")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Lattice Mushroom"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "LatticeMushroom".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class LatticeMushroom : PlantEntity
    {
        ...
        public partial class LatticeMushroomSpecies : PlantSpecies
        {
            public LatticeMushroomSpecies() : base()
            {
                ...
                this.Name = "LatticeMushroom"; //noloc
                this.DisplayName = Localizer.DoStr("Lattice Mushroom"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(15, 35);
                this.GenerationDefinitions.PlantsInGroup = new Range(2, 6);
                ...
                this.ResourceList = new List<SpeciesResource>()
                {
                    ...
                    new SpeciesResource(typeof(LatticeMushroomSporesItem), new Range(1, 2), 0.2f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(LatticeMushroomBlock); // Defines the block type represented by this plant
