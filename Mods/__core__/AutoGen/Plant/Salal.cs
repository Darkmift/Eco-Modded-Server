...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsSalal : PlantLayerSettings
    {
        ...
        {
            this.Name = "Salal";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Salal")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Salal"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Salal".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Salal : PlantEntity
    {
        ...
        public partial class SalalSpecies : PlantSpecies
        {
            public SalalSpecies() : base()
            {
                ...
                this.Name = "Salal"; //noloc
                this.DisplayName = Localizer.DoStr("Salal"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(25, 50);
                ...
                // Visuals
                this.BlockType = typeof(SalalBlock); // Defines the block type represented by this plant
                ...
                // fertilizers.
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Nitrogen", HalfSpeedConcentration = 0.08f, MaxResourceContent = 0.1f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.05f, MaxResourceContent = 0.1f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Potassium", HalfSpeedConcentration = 0.05f, MaxResourceContent = 0.1f }); //noloc
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.05f, MaxResourceContent = 0.05f }); //noloc
