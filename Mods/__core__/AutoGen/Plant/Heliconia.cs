...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsHeliconia : PlantLayerSettings
    {
        public PlantLayerSettingsHeliconia() : base()
        {
            ...
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Heliconia")} Population"); // Sets the localized display name of the plant population layer
    ...
    public partial class Heliconia : PlantEntity
    {
        ...
        public partial class HeliconiaSpecies : PlantSpecies
        {
            public HeliconiaSpecies() : base()
            {
                ...
                this.Name = "Heliconia"; //noloc
                this.DisplayName = Localizer.DoStr("Heliconia"); // Define our localized plant display name
                ...
                // Visuals
                this.BlockType = typeof(HeliconiaBlock); // Defines the block type represented by this plant
