...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsBullrush : PlantLayerSettings
    {
        ...
        {
            this.Name = "Bullrush";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Bullrush")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Bullrush"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Bullrush".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Bullrush : PlantEntity
    {
        ...
        public partial class BullrushSpecies : PlantSpecies
        {
            public BullrushSpecies() : base()
            {
                ...
                this.Name = "Bullrush"; //noloc
                this.DisplayName = Localizer.DoStr("Bullrush"); // Define our localized plant display name
                ...
                // Food
                this.CalorieValue = 3; // Defines the calorie value of the plant
                ...
                // Visuals
                this.BlockType = typeof(BullrushBlock); // Defines the block type represented by this plant
                ...
                // fertilizers.
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Nitrogen", HalfSpeedConcentration = 0.25f, MaxResourceContent = 0.4f }); //noloc
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.4f, MaxResourceContent = 0.2f }); //noloc
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "ShrubSpace", ConsumedCapacityPerPop = 1 }); //noloc

                this.BlanketSpawnPercent = 10;
