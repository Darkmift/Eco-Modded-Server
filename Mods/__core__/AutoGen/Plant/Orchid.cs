...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsOrchid : PlantLayerSettings
    {
        ...
        {
            this.Name = "Orchid";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Orchid")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Orchid"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Orchid".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Orchid : PlantEntity
    {
        ...
        public partial class OrchidSpecies : PlantSpecies
        {
            public OrchidSpecies() : base()
            {
                ...
                this.Name = "Orchid"; //noloc
                this.DisplayName = Localizer.DoStr("Orchid"); // Define our localized plant display name
                ...
                {
                    new SpeciesResource(typeof(OrchidItem), new Range(1, 3), 1),
                    new SpeciesResource(typeof(OrchidSeedItem), new Range(1, 2), 0.1f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(OrchidBlock); // Defines the block type represented by this plant
