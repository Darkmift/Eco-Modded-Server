...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsCotton : PlantLayerSettings
    {
        public PlantLayerSettingsCotton() : base()
        {
            ...
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Cotton")} Population"); // Sets the localized display name of the plant population layer
    ...
    public partial class Cotton : PlantEntity
    {
        ...
        public partial class CottonSpecies : PlantSpecies
        {
            public CottonSpecies() : base()
            {
                ...
                this.Name = "Cotton"; //noloc
                this.DisplayName = Localizer.DoStr("Cotton"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(30, 45);
                this.GenerationDefinitions.PlantsInGroup = new Range(8, 15);
                ...
                // Visuals
                this.BlockType = typeof(CottonBlock); // Defines the block type represented by this plant
