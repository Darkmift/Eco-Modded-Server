...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsBunchgrass : PlantLayerSettings
    {
        ...
        {
            this.Name = "Bunchgrass";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Bunchgrass")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Bunchgrass"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Bunchgrass".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Bunchgrass : PlantEntity
    {
        ...
        public partial class BunchgrassSpecies : PlantSpecies
        {
            public BunchgrassSpecies() : base()
            {
                ...
                this.Name = "Bunchgrass"; //noloc
                this.DisplayName = Localizer.DoStr("Bunchgrass"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(5, 12);
                this.GenerationDefinitions.CountOfClusters = new Range(5, 12);
                ...
                // Visuals
                this.BlockType = typeof(BunchgrassBlock); // Defines the block type represented by this plant
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.2f, MaxResourceContent = 0.1f }); //noloc
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "SoilMoisture", HalfSpeedConcentration = 0.1f, MaxResourceContent = 0.02f }); //noloc
