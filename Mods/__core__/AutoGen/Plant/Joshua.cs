...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsJoshua : PlantLayerSettings
    {
        ...
        {
            this.Name = "Joshua";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Joshua")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Joshua"; //noloc
            this.VoxelsPerEntry = 20;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Joshua".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Joshua : TreeEntity
    {
        ...
        public partial class JoshuaSpecies : TreeSpecies
        {
            public JoshuaSpecies() : base()
            {
                ...
                this.Name = "Joshua"; //noloc
                this.DisplayName = Localizer.DoStr("Joshua"); // Define our localized plant display name

                // Lifetime
                this.MaturityAgeDays = 7; // Maturity age in days.  Organisms older than this value are considered fully grown and can reproduce.
