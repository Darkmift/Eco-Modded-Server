...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsDesertMoss : PlantLayerSettings
    {
        ...
        {
            this.Name = "DesertMoss";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Desert Moss")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Desert Moss"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "DesertMoss".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class DesertMoss : PlantEntity
    {
        ...
        public partial class DesertMossSpecies : PlantSpecies
        {
            public DesertMossSpecies() : base()
            {
                ...
                this.Name = "DesertMoss"; //noloc
                this.DisplayName = Localizer.DoStr("Desert Moss"); // Define our localized plant display name
                ...
                // Visuals
                this.BlockType = typeof(DesertMossBlock); // Defines the block type represented by this plant
                ...
                this.ResourceConstraints.Add(new ResourceConstraint() { LayerName = "Phosphorus", HalfSpeedConcentration = 0.3f, MaxResourceContent = 0.15f }); //noloc
                ...
                this.IdealTemperatureRange = new Range(0.75f, 0.95f);
