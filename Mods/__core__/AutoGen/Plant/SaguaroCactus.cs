...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsSaguaroCactus : PlantLayerSettings
    {
        ...
        {
            this.Name = "SaguaroCactus";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Saguaro Cactus")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Saguaro Cactus"; //noloc
            this.VoxelsPerEntry = 20;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "SaguaroCactus".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class SaguaroCactus : TreeEntity
    {
        ...
        public partial class SaguaroCactusSpecies : TreeSpecies
        {
            public SaguaroCactusSpecies() : base()
            {
                ...
                this.Name = "SaguaroCactus"; //noloc
                this.DisplayName = Localizer.DoStr("Saguaro Cactus"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.ChanceToBeSpawnOutsideOfGroup = 0.2f;
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(30, 60);
                this.GenerationDefinitions.PlantsInGroup = new Range(3, 5);
                this.GenerationDefinitions.CountOfClusters = new Range(1, 1);
                this.GenerationDefinitions.RadiusOfGroup = new Range(3, 5);
                ...
                this.CapacityConstraints.Add(new CapacityConstraint() { CapacityLayerName = "CanopySpace", ConsumedCapacityPerPop = 15 }); //noloc
