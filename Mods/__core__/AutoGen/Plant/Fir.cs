...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsFir : PlantLayerSettings
    {
        ...
        {
            this.Name = "Fir";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Fir")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Subcategory = "Fir".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Fir : TreeEntity
    {
        ...
        public partial class FirSpecies : TreeSpecies
        {
            public FirSpecies() : base()
            {
                ...
                this.Name = "Fir"; //noloc
                this.DisplayName = Localizer.DoStr("Fir"); // Define our localized plant display name
