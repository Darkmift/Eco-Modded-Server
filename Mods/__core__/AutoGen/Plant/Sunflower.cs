...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsSunflower : PlantLayerSettings
    {
        ...
        {
            this.Name = "Sunflower";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Sunflower")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Sunflower"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Sunflower".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Sunflower : PlantEntity
    {
        ...
        public partial class SunflowerSpecies : PlantSpecies
        {
            public SunflowerSpecies() : base()
            {
                ...
                this.Name = "Sunflower"; //noloc
                this.DisplayName = Localizer.DoStr("Sunflower"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(45, 90);
                this.GenerationDefinitions.PlantsInGroup = new Range(8, 20);
                this.GenerationDefinitions.CountOfClusters = new Range(2, 5);
                this.GenerationDefinitions.RadiusOfGroup = new Range(8, 20);
                ...
                {
                    new SpeciesResource(typeof(SunflowerItem), new Range(1, 3), 1),
                    new SpeciesResource(typeof(SunflowerSeedItem), new Range(1, 3), 0.5f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(SunflowerBlock); // Defines the block type represented by this plant

                // Climate
                this.ReleasesCO2TonsPerDay = -0.001f; // Configures the amount of CO2 produced or removed by this plant per day.
