...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsFilmyFern : PlantLayerSettings
    {
        ...
        {
            this.Name = "FilmyFern";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Filmy Fern")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Filmy Fern"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "FilmyFern".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class FilmyFern : PlantEntity
    {
        ...
        public partial class FilmyFernSpecies : PlantSpecies
        {
            public FilmyFernSpecies() : base()
            {
                ...
                this.Name = "FilmyFern"; //noloc
                this.DisplayName = Localizer.DoStr("Filmy Fern"); // Define our localized plant display name
                ...
                // Visuals
                this.BlockType = typeof(FilmyFernBlock); // Defines the block type represented by this plant
