...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsCedar : PlantLayerSettings
    {
        ...
        {
            this.Name = "Cedar";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Cedar")} Population"); // Sets the localized display name of the plant population layer
    ...
    public partial class Cedar : TreeEntity
    {
        ...
        public partial class CedarSpecies : TreeSpecies
        {
            public CedarSpecies() : base()
            {
                ...
                this.Name = "Cedar"; //noloc
                this.DisplayName = Localizer.DoStr("Cedar"); // Define our localized plant display name
