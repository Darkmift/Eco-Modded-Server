...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsSeagrass : PlantLayerSettings
    {
        ...
        {
            this.Name = "Seagrass";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Seagrass")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Seagrass"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Seagrass".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Seagrass : PlantEntity
    {
        ...
        public partial class SeagrassSpecies : PlantSpecies
        {
            public SeagrassSpecies() : base()
            {
                ...
                this.Name = "Seagrass"; //noloc
                this.DisplayName = Localizer.DoStr("Seagrass"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.RadiusOfGroup = new Range(8, 12);
                ...
                // Visuals
                this.BlockType = typeof(SeagrassBlock); // Defines the block type represented by this plant
