...
namespace Eco.Mods.WorldLayers
{
    ...
    /// </remarks>
    public partial class PlantLayerSettingsPitcherPlant : PlantLayerSettings
    {
        public PlantLayerSettingsPitcherPlant() : base()
        {
            this.Name = "PitcherPlant";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Pitcher Plant")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Pitcher Plant"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "PitcherPlant".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
...
namespace Eco.Mods.Organisms
{
    ...
    public partial class PitcherPlant : PlantEntity
    {
        ...
        public partial class PitcherPlantSpecies : PlantSpecies
        {
            public PitcherPlantSpecies() : base()
            {
                ...
                this.Name = "PitcherPlant"; //noloc
                this.DisplayName = Localizer.DoStr("Pitcher Plant"); // Define our localized plant display name
                ...
                // Food
                this.CalorieValue = 0.5f; // Defines the calorie value of the plant
                ...
                // Visuals
                this.BlockType = typeof(PitcherPlantBlock); // Defines the block type represented by this plant
                ...
                this.IdealTemperatureRange = new Range(0.61f, 0.75f);
    ...
    public partial class PitcherPlantBlock :
        PlantBlock { }
}
