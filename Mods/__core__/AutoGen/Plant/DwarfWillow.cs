...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsDwarfWillow : PlantLayerSettings
    {
        ...
        {
            this.Name = "DwarfWillow";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Dwarf Willow")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Dwarf Willow"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "DwarfWillow".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class DwarfWillow : PlantEntity
    {
        ...
        public partial class DwarfWillowSpecies : PlantSpecies
        {
            public DwarfWillowSpecies() : base()
            {
                ...
                this.Name = "DwarfWillow"; //noloc
                this.DisplayName = Localizer.DoStr("Dwarf Willow"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(15, 40);
                this.GenerationDefinitions.PlantsInGroup = new Range(5, 15);
                this.GenerationDefinitions.CountOfClusters = new Range(3, 7);
                this.GenerationDefinitions.RadiusOfGroup = new Range(12, 20);
                ...
                // Visuals
                this.BlockType = typeof(DwarfWillowBlock); // Defines the block type represented by this plant
