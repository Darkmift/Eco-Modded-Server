...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsTrillium : PlantLayerSettings
    {
        ...
        {
            this.Name = "Trillium";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Trillium")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Trillium"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "Trillium".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class Trillium : PlantEntity
    {
        ...
        public partial class TrilliumSpecies : PlantSpecies
        {
            public TrilliumSpecies() : base()
            {
                ...
                this.Name = "Trillium"; //noloc
                this.DisplayName = Localizer.DoStr("Trillium"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.PlantsInGroup = new Range(6, 24);
                ...
                {
                    new SpeciesResource(typeof(TrilliumFlowerItem), new Range(1, 3), 1),
                    new SpeciesResource(typeof(TrilliumSeedItem), new Range(1, 2), 0.1f),
                };
                this.ResourceBonusAtGrowth = 0.9f;

                // Visuals
                this.BlockType = typeof(TrilliumBlock); // Defines the block type represented by this plant
