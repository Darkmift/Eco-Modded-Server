...
namespace Eco.Mods.WorldLayers
{
    ...
    public partial class PlantLayerSettingsOceanSpray : PlantLayerSettings
    {
        ...
        {
            this.Name = "OceanSpray";  //noloc
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Ocean Spray")} Population"); // Sets the localized display name of the plant population layer
            ...
            this.Unit = "Ocean Spray"; //noloc
            this.VoxelsPerEntry = 5;
            this.Category = WorldLayerCategory.Plant;
            this.ValueType = WorldLayerValueType.FillRate;
            this.AreaDescription = "";
            this.Subcategory = "OceanSpray".AddSpacesBetweenCapitals(); //noloc
        }
    }
}
    ...
    public partial class OceanSpray : PlantEntity
    {
        ...
        public partial class OceanSpraySpecies : PlantSpecies
        {
            public OceanSpraySpecies() : base()
            {
                ...
                this.Name = "OceanSpray"; //noloc
                this.DisplayName = Localizer.DoStr("Ocean Spray"); // Define our localized plant display name
                ...
                this.GenerationDefinitions.MinDistanceBetweenGroups = new Range(15, 50);
                this.GenerationDefinitions.PlantsInGroup = new Range(1, 20);
                this.GenerationDefinitions.CountOfClusters = new Range(4, 8);
                this.GenerationDefinitions.RadiusOfGroup = new Range(2, 12);
                ...
                // Visuals
                this.BlockType = typeof(OceanSprayBlock); // Defines the block type represented by this plant
