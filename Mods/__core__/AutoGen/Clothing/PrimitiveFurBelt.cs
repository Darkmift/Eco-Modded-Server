...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Primitive Fur Belt")] // Defines the localized name of the item.
    [LocDescription("You should probably still wear pants.")] //The tooltip description for this clothing item.
    [StartsDiscovered] // Tells the server this item starts discovered when a new server is made.
    [Weight(100)] // Defines how heavy the PrimitiveFurBelt is.
    [Tag("Clothes")]
