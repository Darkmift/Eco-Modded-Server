...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Primitive Canvas Boots")] // Defines the localized name of the item.
    [LocDescription("A pair of crude canvas boots for your everyday use.")] //The tooltip description for this clothing item.
    [StartsDiscovered] // Tells the server this item starts discovered when a new server is made.
    [Weight(100)] // Defines how heavy the PrimitiveCanvasBoots is.
    [Tag("Clothes")]
