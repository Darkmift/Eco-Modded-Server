...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Primitive Leather Pants")] // Defines the localized name of the item.
    [LocDescription("You ever tried cutting leather with a rock?")] //The tooltip description for this clothing item.
    [StartsDiscovered] // Tells the server this item starts discovered when a new server is made.
    [Weight(100)] // Defines how heavy the PrimitiveLeatherPants is.
    [Tag("Clothes")]
