...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Primitive Leather Boots")] // Defines the localized name of the item.
    [LocDescription("A pair of crude leather boots for your everyday use.")] //The tooltip description for this clothing item.
    [StartsDiscovered] // Tells the server this item starts discovered when a new server is made.
    [Weight(100)] // Defines how heavy the PrimitiveLeatherBoots is.
    [Tag("Clothes")]
