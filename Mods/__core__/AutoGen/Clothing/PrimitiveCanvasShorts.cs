...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Primitive Canvas Shorts")] // Defines the localized name of the item.
    [LocDescription("They're like the Primitive Canvas Pants, but shorter.")] //The tooltip description for this clothing item.
    [StartsDiscovered] // Tells the server this item starts discovered when a new server is made.
    [Weight(100)] // Defines how heavy the PrimitiveCanvasShorts is.
    [Tag("Clothes")]
