...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Primitive Canvas Pants")] // Defines the localized name of the item.
    [LocDescription("Roughly stitched canvas pants.")] //The tooltip description for this clothing item.
    [StartsDiscovered] // Tells the server this item starts discovered when a new server is made.
    [Weight(100)] // Defines how heavy the PrimitiveCanvasPants is.
    [Tag("Clothes")]
