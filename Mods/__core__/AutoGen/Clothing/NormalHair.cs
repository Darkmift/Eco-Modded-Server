...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Normal Hair")] // Defines the localized name of the item.
    [LocDescription("The hair with a completely normal amount of flare.")] //The tooltip description for this clothing item.
