...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Tunic")] // Defines the localized name of the item.
    [LocDescription("A simply made canvas shirt. Does not have a pocket to put your pen in.")] //The tooltip description for this clothing item.
    [StartsDiscovered] // Tells the server this item starts discovered when a new server is made.
    [Weight(100)] // Defines how heavy the Tunic is.
    [Tag("Clothes")]
