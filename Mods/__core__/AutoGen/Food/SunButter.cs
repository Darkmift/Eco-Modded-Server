...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Sun Butter")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [LocDescription("A revolutionary method to acquire butter.")] //The tooltip description for the food item.
