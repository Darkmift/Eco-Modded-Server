...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Tallow")] // Defines the localized name of the item.
    [Weight(100)] // Defines how heavy the Tallow is.
    [Fuel(2000)][Tag("Fuel")] // Marks the Tallow as fuel item.
    [Tag("Fat")]
    [Ecopedia("Food", "Ingredients", createAsSubPage: true)]
    [LocDescription("Rendered animal fat useful for more than just cooking.")] //The tooltip description for the food item.
