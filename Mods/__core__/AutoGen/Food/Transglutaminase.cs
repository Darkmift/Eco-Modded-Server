...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Transglutaminase")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(100)] // Defines how heavy the Transglutaminase is.
    [LocDescription("Any enzyme that can be used to bond proteins together.")] //The tooltip description for the food item.
