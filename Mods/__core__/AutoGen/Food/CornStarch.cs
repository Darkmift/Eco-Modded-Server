...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Corn Starch")] // Defines the localized name of the item.
    [Category("Hidden")] // Hides this object from the player. It is not recommended you remove this tag.
    [Weight(100)] // Defines how heavy the CornStarch is.
    [LocDescription("Obtained from the endosperm of the kernal, cornstarch can be used as a thickening agent for sauces.")] //The tooltip description for the food item.
