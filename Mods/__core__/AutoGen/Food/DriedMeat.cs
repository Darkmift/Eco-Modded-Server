...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Dried Meat")] // Defines the localized name of the item.
    [Weight(250)] // Defines how heavy the DriedMeat is.
    ...
    public partial class DriedMeatItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 1, Fat = 4, Protein = 14, Vitamins = 0};
