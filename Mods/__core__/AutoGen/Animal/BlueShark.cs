    ...
    public class BlueShark : AnimalEntity
    {
        ...
        public class BlueSharkSpecies : AnimalSpecies
        {
            public BlueSharkSpecies() : base()
            {
                ...
                this.InstanceType = typeof(BlueShark); // Define our instance type to be a typeof instance of our selves.
                ...
                this.Name = "BlueShark"; //noloc
                this.DisplayName = Localizer.DoStr("Blue Shark");
                ...
                {
                    typeof(Bass),
                    typeof(PacificSardine),
                    typeof(Tuna),
                    typeof(Crab),
                    typeof(MoonJellyfish),
                };
                ...
                {
                    new SpeciesResource(typeof(BlueSharkItem), new Range(1, 1)),
                };
