    ...
    public class PacificSardine : AnimalEntity
    {
        ...
        public class PacificSardineSpecies : AnimalSpecies
        {
            public PacificSardineSpecies() : base()
            {
                ...
                this.InstanceType = typeof(PacificSardine); // Define our instance type to be a typeof instance of our selves.
                ...
                this.Name = "PacificSardine"; //noloc
                this.DisplayName = Localizer.DoStr("Pacific Sardine");
                ...
                {
                    new SpeciesResource(typeof(PacificSardineItem), new Range(1, 1)),
                };
