    ...
    public class Trout : AnimalEntity
    {
        ...
        public class TroutSpecies : AnimalSpecies
        {
            public TroutSpecies() : base()
            {
                ...
                this.InstanceType = typeof(Trout); // Define our instance type to be a typeof instance of our selves.
                ...
                {
                    new SpeciesResource(typeof(TroutItem), new Range(1, 1)),
                };
