    ...
    public class MoonJellyfish : AnimalEntity
    {
        ...
        public class MoonJellyfishSpecies : AnimalSpecies
        {
            public MoonJellyfishSpecies() : base()
            {
                ...
                this.InstanceType = typeof(MoonJellyfish); // Define our instance type to be a typeof instance of our selves.
                ...
                this.Name = "MoonJellyfish"; //noloc
                this.DisplayName = Localizer.DoStr("Moon Jellyfish");
                ...
                {
                    new SpeciesResource(typeof(MoonJellyfishItem), new Range(1, 1)),
                };
