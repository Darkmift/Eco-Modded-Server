    ...
    public class Deer : AnimalEntity
    {
        ...
        public class DeerSpecies : AnimalSpecies
        {
            public DeerSpecies() : base()
            {
                ...
                this.InstanceType = typeof(Deer); // Define our instance type to be a typeof instance of our selves.
                ...
                this.Name = "Deer"; //noloc
                this.DisplayName = Localizer.DoStr("Deer");
                this.DisplayDescription = Localizer.DoStr("A graceful, herbivorous mammal with a reddish-brown coat that inhabits forests and fields. Deer have evolved a variety of adaptations to avoid predators, such as their excellent sense of hearing, smell, and vision, as well as their ability to run fast and jump high.");
                ...
                {
                    new SpeciesResource(typeof(DeerCarcassItem), new Range(1, 1)),
                };
