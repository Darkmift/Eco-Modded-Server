    ...
    public class Crab : AnimalEntity
    {
        ...
        public class CrabSpecies : AnimalSpecies
        {
            public CrabSpecies() : base()
            {
                ...
                this.InstanceType = typeof(Crab); // Define our instance type to be a typeof instance of our selves.
                ...
                this.Name = "Crab"; //noloc
                this.DisplayName = Localizer.DoStr("Crab");
                this.DisplayDescription = Localizer.DoStr("A crustacean with a hard exoskeleton and two large pincers used for defense, feeding, and courtship displays. Crabs are omnivores and feed on a variety of foods, including algae, other invertebrates, and carrion.");
                ...
                {
                    new SpeciesResource(typeof(CrabCarcassItem), new Range(1, 1)),
                };
