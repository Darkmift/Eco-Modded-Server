    ...
    public class Tuna : AnimalEntity
    {
        ...
        public class TunaSpecies : AnimalSpecies
        {
            public TunaSpecies() : base()
            {
                ...
                this.InstanceType = typeof(Tuna); // Define our instance type to be a typeof instance of our selves.
                ...
                {
                    new SpeciesResource(typeof(TunaItem), new Range(1, 1)),
                };
