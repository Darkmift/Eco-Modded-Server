    ...
    public class Fox : AnimalEntity
    {
        ...
        public class FoxSpecies : AnimalSpecies
        {
            public FoxSpecies() : base()
            {
                ...
                this.InstanceType = typeof(Fox); // Define our instance type to be a typeof instance of our selves.
                ...
                this.DisplayDescription = Localizer.DoStr("A small and agile canid with a reddish-orange fur coat and a bushy tail. Foxes are known for their intelligence and problem-solving skills, and have been observed using tools and displaying advanced problem-solving abilities in the wild.");
                ...
                {
                    new SpeciesResource(typeof(FoxCarcassItem), new Range(1, 1)),
                };
