    ...
    public class Jaguar : AnimalEntity
    {
        ...
        public class JaguarSpecies : AnimalSpecies
        {
            public JaguarSpecies() : base()
            {
                ...
                this.InstanceType = typeof(Jaguar); // Define our instance type to be a typeof instance of our selves.
                ...
                this.Name = "Jaguar"; //noloc
                this.DisplayName = Localizer.DoStr("Jaguar");
                this.DisplayDescription = Localizer.DoStr("A large wild cat with distinctive black spots and a muscular build, often found in dense rainforests. Jaguars are apex predators and have no natural enemies, although they can be threatened by habitat loss and poaching.");
                ...
                {
                    new SpeciesResource(typeof(JaguarCarcassItem), new Range(1, 1)),
                };
