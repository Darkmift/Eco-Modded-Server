...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side animal entity definition for "Tarantula".</para>
    ...
    public class Tarantula : AnimalEntity
    {
        ...
        /// <summary>
        /// <para>Server side species definition for "Tarantula".</para>
        ...
        /// </summary>
        /// <inheritdoc/>
        [Ecopedia("Animals", "Invertebrates", createAsSubPage: true)]
        ...
        public class TarantulaSpecies : AnimalSpecies
        {
            public TarantulaSpecies() : base()
            {
                ...
                this.InstanceType = typeof(Tarantula); // Define our instance type to be a typeof instance of our selves.
                ...
                this.DisplayDescription = Localizer.DoStr("A large, hairy spider with a distinctive body shape and a venomous bite. Tarantulas are nocturnal and often spend the day hiding in burrows or other sheltered locations.");
                ...
                // Define the tag strings that represent this animal species
