...
namespace Eco.Mods.TechTree
{
    ...
    [ForceCreateView]
    public partial class WeaveSmallCottonBuntingFestiveRecipe : Recipe
    {
        public WeaveSmallCottonBuntingFestiveRecipe()
        {
            this.Init(
                name: "WeaveSmallCottonBuntingFestive",  //noloc
                displayName: Localizer.DoStr("Weave Small Cotton Bunting Festive"),
                ...
                {
                    new CraftingElement<SmallCottonBuntingFestiveItem>(2),
                });
