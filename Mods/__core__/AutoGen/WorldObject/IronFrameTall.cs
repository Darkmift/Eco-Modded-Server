...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(2)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Cultural", subPageName: "Iron Frame Tall Item")]
            public partial class IronFrameTallObject : PictureFrameObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(IronFrameTallItem);
        public override LocString DisplayName => Localizer.DoStr("Iron Frame Tall");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = IronFrameTallItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy IronFrameTall is.
            public partial class IronFrameTallItem : WorldObjectItem<IronFrameTallObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(IronFrameTallObject).UILink(),
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Cultural", subPageName: "Iron Frame Tall Item")]
    public partial class IronFrameTallRecipe : Recipe
    {
        public IronFrameTallRecipe()
        {
            this.Init(
                name: "IronFrameTall",  //noloc
                displayName: Localizer.DoStr("Iron Frame Tall"),
                ...
                {
                    new CraftingElement<IronFrameTallItem>()
                });
