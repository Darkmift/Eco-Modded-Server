...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Signs", subPageName: "Large Standing Birch Sign Item")]
            public partial class LargeStandingBirchSignObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(LargeStandingBirchSignItem);
        public override LocString DisplayName => Localizer.DoStr("Large Standing Birch Sign");
    ...
    [Weight(2000)] // Defines how heavy LargeStandingBirchSign is.
            public partial class LargeStandingBirchSignItem : WorldObjectItem<LargeStandingBirchSignObject>, IPersistentData
    {
    ...
    [ForceCreateView]
    [Ecopedia("Crafted Objects", "Signs", subPageName: "Large Standing Birch Sign Item")]
    public partial class LargeStandingBirchSignRecipe : Recipe
    {
        public LargeStandingBirchSignRecipe()
        {
            this.Init(
                name: "LargeStandingBirchSign",  //noloc
                displayName: Localizer.DoStr("Large Standing Birch Sign"),
