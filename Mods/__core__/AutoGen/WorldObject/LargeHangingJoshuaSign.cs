...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Signs", subPageName: "Large Hanging Joshua Sign Item")]
            public partial class LargeHangingJoshuaSignObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(LargeHangingJoshuaSignItem);
        public override LocString DisplayName => Localizer.DoStr("Large Hanging Joshua Sign");
    ...
    [Weight(2000)] // Defines how heavy LargeHangingJoshuaSign is.
            public partial class LargeHangingJoshuaSignItem : WorldObjectItem<LargeHangingJoshuaSignObject>, IPersistentData
    {
    ...
    [ForceCreateView]
    [Ecopedia("Crafted Objects", "Signs", subPageName: "Large Hanging Joshua Sign Item")]
    public partial class LargeHangingJoshuaSignRecipe : Recipe
    {
        public LargeHangingJoshuaSignRecipe()
        {
            this.Init(
                name: "LargeHangingJoshuaSign",  //noloc
                displayName: Localizer.DoStr("Large Hanging Joshua Sign"),
