...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(4)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Bedroom", subPageName: "Hewn Nightstand Item")]
    ...
    public partial class HewnNightstandRecipe : RecipeFamily
    {
        public HewnNightstandRecipe()
        {
            ...
            recipe.Init(
                name: "HewnNightstand",  //noloc
                displayName: Localizer.DoStr("Hewn Nightstand"),
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Hewn Nightstand"), recipeType: typeof(HewnNightstandRecipe));
            this.ModsPostInitialize();
