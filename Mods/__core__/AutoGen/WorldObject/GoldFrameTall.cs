...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Housing Objects", "Cultural", subPageName: "Gold Frame Tall Item")]
            public partial class GoldFrameTallObject : PictureFrameObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(GoldFrameTallItem);
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = GoldFrameTallItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(1000)] // Defines how heavy GoldFrameTall is.
            public partial class GoldFrameTallItem : WorldObjectItem<GoldFrameTallObject>, IPersistentData
    {
        ...
        {
            ObjectName                              = typeof(GoldFrameTallObject).UILink(),
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Cultural", subPageName: "Gold Frame Tall Item")]
    public partial class GoldFrameTallRecipe : Recipe
    {
        public GoldFrameTallRecipe()
        {
            this.Init(
                name: "GoldFrameTall",  //noloc
                ...
                {
                    new CraftingElement<GoldFrameTallItem>()
                });
