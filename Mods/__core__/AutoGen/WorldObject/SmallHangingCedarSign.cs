...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Signs", subPageName: "Small Hanging Cedar Sign Item")]
            public partial class SmallHangingCedarSignObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(SmallHangingCedarSignItem);
        public override LocString DisplayName => Localizer.DoStr("Small Hanging Cedar Sign");
    ...
    [Weight(1000)] // Defines how heavy SmallHangingCedarSign is.
            public partial class SmallHangingCedarSignItem : WorldObjectItem<SmallHangingCedarSignObject>, IPersistentData
    {
    ...
    [ForceCreateView]
    [Ecopedia("Crafted Objects", "Signs", subPageName: "Small Hanging Cedar Sign Item")]
    public partial class SmallHangingCedarSignRecipe : Recipe
    {
        public SmallHangingCedarSignRecipe()
        {
            this.Init(
                name: "SmallHangingCedarSign",  //noloc
                displayName: Localizer.DoStr("Small Hanging Cedar Sign"),
