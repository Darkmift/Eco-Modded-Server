...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Living Room", subPageName: "Ashlar Sandstone Fireplace Item")]
            public partial class AshlarSandstoneFireplaceObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AshlarSandstoneFireplaceItem);
        public override LocString DisplayName => Localizer.DoStr("Ashlar Sandstone Fireplace");
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = AshlarSandstoneFireplaceItem.homeValue;
    ...
    [Tag("Housing")]
    [Weight(5000)] // Defines how heavy AshlarSandstoneFireplace is.
            public partial class AshlarSandstoneFireplaceItem : WorldObjectItem<AshlarSandstoneFireplaceObject>
    {
        protected override OccupancyContext GetOccupancyContext => new SideAttachedContext( 0  | DirectionAxisFlags.Down , WorldObject.GetOccupancyInfo(this.WorldObjectType));
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName                              = typeof(AshlarSandstoneFireplaceObject).UILink(),
    ...
    [ForceCreateView]
    [Ecopedia("Housing Objects", "Living Room", subPageName: "Ashlar Sandstone Fireplace Item")]
    public partial class AshlarSandstoneFireplaceRecipe : Recipe
    {
        public AshlarSandstoneFireplaceRecipe()
        {
            this.Init(
                name: "AshlarSandstoneFireplace",  //noloc
                displayName: Localizer.DoStr("Ashlar Sandstone Fireplace"),
