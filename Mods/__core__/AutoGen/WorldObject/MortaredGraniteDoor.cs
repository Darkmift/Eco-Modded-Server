...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Doors", subPageName: "Mortared Granite Door Item")]
    ...
    [Weight(1000)] // Defines how heavy MortaredGraniteDoor is.
    ...
    public partial class MortaredGraniteDoorRecipe : Recipe
    {
        ...
        {
            this.Init(
                name: "MortaredGraniteDoor",  //noloc
                displayName: Localizer.DoStr("Mortared Granite Door"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(MortaredGraniteItem), 2, true),
                },
