...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Human Limbs")] // Defines the localized name of the item.
    [LocDescription("Limbs")] //The tooltip description for this clothing item.
    [Weight(0)] // Defines how heavy the HumanLimbs is.
    [Category("Hidden"), Tag("NotInBrowser"), NoIcon] // Hides this object from the player. It is not recommended you remove this tag. 
    public partial class HumanLimbsItem : ClothingItem
    {

        /// <summary>Slot this clothing type belongs to</summary>
        public override string Slot                  { get { return AvatarAppearanceSlots.Limbs; } }
    }
}
