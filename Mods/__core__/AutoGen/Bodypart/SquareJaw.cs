...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Square Jaw")] // Defines the localized name of the item.
    [LocDescription("Jaw")] //The tooltip description for this clothing item.
    [Weight(0)] // Defines how heavy the SquareJaw is.
    [Category("Hidden"), Tag("NotInBrowser"), NoIcon] // Hides this object from the player. It is not recommended you remove this tag. 
    public partial class SquareJawItem : ClothingItem
    {
