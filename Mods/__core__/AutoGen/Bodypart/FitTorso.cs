...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Fit Torso")] // Defines the localized name of the item.
    [LocDescription("Torso")] //The tooltip description for this clothing item.
    [Weight(0)] // Defines how heavy the FitTorso is.
    [Category("Hidden"), Tag("NotInBrowser"), NoIcon] // Hides this object from the player. It is not recommended you remove this tag. 
    public partial class FitTorsoItem : ClothingItem
    {

        /// <summary>Slot this clothing type belongs to</summary>
        public override string Slot                  { get { return AvatarAppearanceSlots.Torso; } }
    }
}
