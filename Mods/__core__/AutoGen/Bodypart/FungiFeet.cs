...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Fungi Feet")] // Defines the localized name of the item.
    [LocDescription("Feet")] //The tooltip description for this clothing item.
    [Weight(0)] // Defines how heavy the FungiFeet is.
    [Category("Hidden"), Tag("NotInBrowser"), NoIcon] // Hides this object from the player. It is not recommended you remove this tag. 
    public partial class FungiFeetItem : ClothingItem
    {

        /// <summary>Slot this clothing type belongs to</summary>
        public override string Slot                  { get { return AvatarAppearanceSlots.Feet; } }
    }
}
