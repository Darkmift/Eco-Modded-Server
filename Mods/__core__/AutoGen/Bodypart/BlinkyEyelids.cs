...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Blinky Eyelids")] // Defines the localized name of the item.
    [LocDescription("Eyes")] //The tooltip description for this clothing item.
    [Weight(0)] // Defines how heavy the BlinkyEyelids is.
    [Category("Hidden"), Tag("NotInBrowser"), NoIcon] // Hides this object from the player. It is not recommended you remove this tag. 
    public partial class BlinkyEyelidsItem : ClothingItem
    {

        /// <summary>Slot this clothing type belongs to</summary>
        public override string Slot                  { get { return AvatarAppearanceSlots.Eyelids; } }
    }
}
