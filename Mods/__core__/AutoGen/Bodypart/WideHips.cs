...
namespace Eco.Mods.TechTree
{
    ...
    [LocDisplayName("Wide Hips")] // Defines the localized name of the item.
    [LocDescription("Hips")] //The tooltip description for this clothing item.
    [Weight(0)] // Defines how heavy the WideHips is.
    [Category("Hidden"), Tag("NotInBrowser"), NoIcon] // Hides this object from the player. It is not recommended you remove this tag. 
    public partial class WideHipsItem : ClothingItem
    {

        /// <summary>Slot this clothing type belongs to</summary>
        public override string Slot                  { get { return AvatarAppearanceSlots.Hips; } }
    }
}
