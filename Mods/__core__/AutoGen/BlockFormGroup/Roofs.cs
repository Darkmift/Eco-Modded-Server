...
namespace Eco.Mods.TechTree
{
    ...
    /// </remarks>
    /// </summary>
    public partial class RoofsFormGroup : FormGroup
    {
        /// <summary>Defines the name of the form group.</summary>
        public override string Name => "Roofs"; //noloc
        /// <summary>The pural localization name for block form group.</summary> 
        public override LocString DisplayName => Localizer.DoStr("Roofs");
        /// <summary>The tooltip description for the food item.</summary>
        public override LocString DisplayDescription => Localizer.DoStr("Roofs");
