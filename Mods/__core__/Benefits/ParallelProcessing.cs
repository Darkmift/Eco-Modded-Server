...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ParallelProcessingTalent : Talent
    {
        ...
        public override bool Active(object obj, User user = null)
        {
            ...
            if (cc != null)
                if (cc.Parent.TryGetComponent<RoomRequirementsComponent>(out var reqComp) && reqComp.LastRoomStats?.ContainedWorldObjects.Where(x => x.GetType() == cc.Parent.GetType()).Count() < 2)
                    return false;
