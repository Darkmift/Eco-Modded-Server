...
namespace Eco.Mods.WorldLayers
{
    ...
    public class AnimalLayerSettingsBeaver : AnimalLayerSettings
    {
        public AnimalLayerSettingsBeaver() : base()
        {
            this.Name = "Beaver";
            this.DisplayName = Localizer.Do($"{Localizer.DoStr("Beaver")} Population");
            ...
            this.HabitabilityLayer = "BeaverCapacity";
