...
namespace Eco.Mods.WorldLayers
{
    ...
    {
        public AnimalLayerSettingsPrairieDog() : base()
        {
            this.Name = "PrairieDog";
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Prairie Dog")} Population");
            ...
            this.HabitabilityLayer = "PrairieDogCapacity";
