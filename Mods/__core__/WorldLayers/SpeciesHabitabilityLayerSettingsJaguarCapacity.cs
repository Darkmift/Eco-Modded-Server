...
namespace Eco.Mods.WorldLayers
{
    ...
    {
        public SpeciesHabitabilityLayerSettingsJaguarCapacity() : base()
        {
            this.Species = "Jaguar";
            ...
            { 
                ...
                { 
                    typeof(AnimalLayerSettingsAgouti),
                    typeof(AnimalLayerSettingsSnappingTurtle)
                } 
            } );
            this.Name = "JaguarCapacity";
            this.MinimapName = Localizer.DoStr("Jaguar Capacity");
