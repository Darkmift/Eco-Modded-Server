...
namespace Eco.Mods.WorldLayers
{
    ...
    public class SpeciesHabitabilityLayerSettingsFoxCapacity : SpeciesHabitabilityLayerSettings
    {
        ...
        {
            this.Species = "Fox";
            this.HabitabilityComponents.Add( new ConsumerComponent() { CalorieConsumption = 150, Prey = new List<Type> { typeof(AnimalLayerSettingsHare), typeof(AnimalLayerSettingsPrairieDog), typeof(AnimalLayerSettingsTurkey) } } );
            this.Name = "FoxCapacity";
            this.MinimapName = Localizer.DoStr("Fox Capacity");
