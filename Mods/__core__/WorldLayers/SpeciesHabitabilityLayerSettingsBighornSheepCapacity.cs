...
namespace Eco.Mods.WorldLayers
{
    ...
    public class SpeciesHabitabilityLayerSettingsBighornSheepCapacity : SpeciesHabitabilityLayerSettings
    {
        public SpeciesHabitabilityLayerSettingsBighornSheepCapacity() : base()
        {
            ...
            this.HabitabilityComponents.Add( new ConsumerComponent() { CalorieConsumption = 80, Prey = new List<Type> { typeof(PlantLayerSettingsPricklyPear), typeof(PlantLayerSettingsAgave), typeof(PlantLayerSettingsCreosoteBush), typeof(PlantLayerSettingsJointfir), typeof(PlantLayerSettingsWhiteBursage), typeof(PlantLayerSettingsDesertMoss) } } );
            this.Name = "BighornSheepCapacity";
            this.MinimapName = Localizer.DoStr("Bighorn Sheep Capacity");
