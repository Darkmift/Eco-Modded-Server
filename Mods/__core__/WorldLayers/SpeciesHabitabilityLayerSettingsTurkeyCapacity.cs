...
namespace Eco.Mods.WorldLayers
{
    ...
    public class SpeciesHabitabilityLayerSettingsTurkeyCapacity : SpeciesHabitabilityLayerSettings
    {
        ...
        {
            this.Species = "Turkey";
            this.HabitabilityComponents.Add( new ConsumerComponent() { CalorieConsumption = 40, Prey = new List<Type> { typeof(PlantLayerSettingsBunchgrass), typeof(PlantLayerSettingsCamas) } } );
            this.Name = "TurkeyCapacity";
            this.MinimapName = Localizer.DoStr("Turkey Capacity");
