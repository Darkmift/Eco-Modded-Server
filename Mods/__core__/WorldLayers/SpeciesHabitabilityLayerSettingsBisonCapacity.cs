...
namespace Eco.Mods.WorldLayers
{
    ...
    public class SpeciesHabitabilityLayerSettingsBisonCapacity : SpeciesHabitabilityLayerSettings
    {
        ...
        {
            this.Species = "Bison";
            this.HabitabilityComponents.Add( new ConsumerComponent() { CalorieConsumption = 500, Prey = new List<Type> { typeof(PlantLayerSettingsWheat), typeof(PlantLayerSettingsBigBluestem), typeof(PlantLayerSettingsBunchgrass), typeof(PlantLayerSettingsCommonGrass), typeof(PlantLayerSettingsCorn), typeof(PlantLayerSettingsSwitchgrass) } } );
            this.Name = "BisonCapacity";
            this.MinimapName = Localizer.DoStr("Bison Capacity");
