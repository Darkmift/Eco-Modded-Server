...
namespace Eco.Mods.WorldLayers
{
    ...
    {
        public AnimalLayerSettingsPacificSardine() : base()
        {
            this.Name = "PacificSardine";
            this.MinimapName = Localizer.Do($"{Localizer.DoStr("Pacific Sardine")} Population");
            ...
            this.HabitabilityLayer = "PacificSardineCapacity";
